...
getColor <- function(visited){
  ...
  if(type == "np"){
    ...
    "orange"
      ...
      "purple"
    }else if(type == "nra" | type == "nr" | type == "ns" | type == "nl" | type == "pkwy"){
      "purple"
    }else{
    "pink"
  } })
