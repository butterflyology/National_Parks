...
visited <- read_csv("data/NP_visited.csv", col_names = TRUE, 
                    ...
                    col_types = list(
                      ...
                      lat = col_double(), 
                      lng = col_double(), 
                      type = col_factor(levels = c("np", "nhp", "nb", "nm", "nhs", "nmp", "nmem", "nhres", "mem", "park", "nbp", "nr", "nra", "ns", "mempkwy", "nha", "nl", "nr", "pkwy", "nht"))))
```
...
getColor <- function(visited){
  ...
  if(type == "np"){
    "green"
  }else if(type == "nhs" | type == "nhp" | type == "nhres" | type == "nha" | type == "nht"){
    "orange"
